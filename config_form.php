...
<p>
	<b><?php echo __('Please note');?></b>: <?php echo __('In most cases, you will want to add whichever field you select here to the list of sort links in your browse views. Check %s for an example.', '<em>/Omekaroot/themes/default/items/browse</em>');?>
</p>
...
<div class="field">
	...
	<div class="inputs five columns omega">
		<p class="explanation">
			<?php echo __('Choose the field all excluded Collections will be sorted by.'); ?>
		</p>
